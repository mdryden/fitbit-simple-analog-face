...
function memoryToConsole(where) {
  ...
  console.info(
    "JS memory:       used: " +
      memory.js.used.toLocaleString() +
      " peak: " +
      memory.js.peak.toLocaleString() +
      " total: " +
      memory.js.total.toLocaleString(),
  );
  console.info(
    "Native memory:   used: " +
      memory.native.used.toLocaleString() +
      " peak: " +
      memory.native.peak.toLocaleString() +
      " total: " +
      memory.native.total.toLocaleString(),
  );
...
clock.ontick = evt => {
  ...
  //     ? today.adjusted.distance * 0.001
  //     : today.adjusted.distance * 0.000621371;
